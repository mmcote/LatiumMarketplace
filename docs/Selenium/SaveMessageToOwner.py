...
class SendMessageToOwner(unittest.TestCase):
    def setUp(self):
    ...
    def test_send_message_to_owner(self):
        ...
        driver.find_element_by_id("loginButton").click()
        driver.find_element_by_link_text("Marketplace").click()
        driver.find_element_by_id("AssetDetailsButton").click()
        driver.find_element_by_link_text("Respond to message").click()
        driver.find_element_by_id("Subject").clear()
        driver.find_element_by_id("Subject").send_keys("Hello This is a test")
