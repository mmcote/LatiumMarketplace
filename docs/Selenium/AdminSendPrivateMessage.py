...
class AdminSendPrivateMessage(unittest.TestCase):
    def setUp(self):
    ...
    def test_admin_send_private_message(self):
        driver = self.driver
        ...
        driver.find_element_by_id("Subject").send_keys("Hello this is a private message")
        driver.find_element_by_id("Body").clear()
        driver.find_element_by_id("Body").send_keys("Hello.")
