...
class AddSaleItem(unittest.TestCase):
    def setUp(self):
    ...
    def test_add_sale_item(self):
        ...
        driver.find_element_by_id("name").send_keys("Test-Asset-For-Sale")
        ...
        driver.find_element_by_id("Address").send_keys("Newport beach")
        Select(driver.find_element_by_id("Cities")).select_by_visible_text("Edmonton")
        Select(driver.find_element_by_id("Cities")).select_by_visible_text("Calgary")
        Select(driver.find_element_by_id("Cities")).select_by_visible_text("Vancouver")
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys("This is a test description.")
        driver.find_element_by_id("price").clear()
        driver.find_element_by_id("price").send_keys("19.00")
        driver.find_element_by_id("accessories-yes").click()
        driver.find_element_by_css_selector("#asset-accessories-radio-container > label.radio-inline").click()
        driver.find_element_by_name("accessoryName").clear()
        driver.find_element_by_name("accessoryName").send_keys("Accessory 01")
        driver.find_element_by_name("accessoryPrice").clear()
        driver.find_element_by_name("accessoryPrice").send_keys("90")
