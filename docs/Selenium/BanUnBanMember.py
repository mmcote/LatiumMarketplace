...
class BanUnBanMember(unittest.TestCase):
    def setUp(self):
    ...
    def test_ban_un_ban_member(self):
        driver = self.driver
        ...
        driver.find_element_by_link_text("Ban").click()
        driver.find_element_by_link_text("Back to Admin Panel").click()
        ...
        driver.find_element_by_id("loginButton").click()
        driver.find_element_by_link_text("Admin").click()
        driver.find_element_by_link_text("Unban").click()
        driver.find_element_by_xpath("(//button[@type='button'])[2]").click()
        driver.find_element_by_link_text("Log Off").click()
        driver.find_element_by_link_text("Log in").click()
        driver.find_element_by_id("Email").clear()
