...
class DeleteAnAssetRequest(unittest.TestCase):
    def setUp(self):
    ...
    def test_delete_an_asset_request(self):
        driver = self.driver
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "Big Rig"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_xpath("(//button[@type='button'])[2]").click()
        driver.find_element_by_link_text("My MyListings").click()
