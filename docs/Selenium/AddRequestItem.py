...
class AddRequestItem(unittest.TestCase):
    def setUp(self):
    ...
    def test_add_request_item(self):
        driver = self.driver
        ...
        driver.find_element_by_id("name").send_keys("Test-Request-Asset")
        driver.find_element_by_id("duration").clear()
        driver.find_element_by_id("duration").send_keys("One Month")
        ...
        Select(driver.find_element_by_id("AssetCategories")).select_by_visible_text("Truck")
        driver.find_element_by_id("Address").clear()
        driver.find_element_by_id("Address").send_keys("New-Port Beach")
        ...
        driver.find_element_by_id("description").send_keys("Request Description")
        driver.find_element_by_id("accessory").clear()
        driver.find_element_by_id("accessory").send_keys("All of the accessories.")
