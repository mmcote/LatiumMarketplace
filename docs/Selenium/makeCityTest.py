...
class MakeCityTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_make_city(self):
        ...
        driver.find_element_by_link_text("All Cities").click()
        driver.find_element_by_id("newCityName").clear()
        driver.find_element_by_id("newCityName").send_keys("Quebec")
