...
class BidOnAsset(unittest.TestCase):
    def setUp(self):
    ...
    def test_bid_on_asset(self):
        ...
        driver.find_element_by_id("loginButton").click()
        driver.find_element_by_link_text("Marketplace").click()
        driver.find_element_by_id("I need a big rig").click()
        driver.find_element_by_link_text("Place a bid").click()
        driver.find_element_by_id("bidPrice").clear()
        driver.find_element_by_id("bidPrice").send_keys("34")
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys("bid on request")
        driver.find_element_by_id("endDate").clear()
        driver.find_element_by_id("endDate").send_keys("03/23/2017")
        driver.find_element_by_id("startDate").clear()
        driver.find_element_by_id("startDate").send_keys("03/23/2017")
        driver.find_element_by_css_selector("input.btn.btn-default").click()
        # Warning: verifyTextPresent may require manual changes
        try: self.assertRegexpMatches(driver.find_element_by_css_selector("BODY").text, r"^[\s\S]*$")
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.find_element_by_id("loginButton").click()
        driver.find_element_by_xpath("(//button[@type='button'])[2]").click()
        driver.find_element_by_link_text("My Bids").click()
